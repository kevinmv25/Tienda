...
public class EditarProductoController {
    ...
    public void setProducto(Producto producto) {
        ...
        txtCantidad.setText(producto.getCaducidad());

        choiceTipo.setValue(producto.getTipoProducto());
    }
    ...
    private void guardarCambios(){
        ...
        producto.setTipoProducto(choiceTipo.getValue());
        producto.setCaducidad(txtCantidad.getText());
